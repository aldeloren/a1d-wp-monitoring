...
use TenUp\A1D_Monitoring_and_Management as Base;
...
class Core_Tests extends Base\TestCase {
	...
	public function test_i18n() {
		...
		\WP_Mock::wpFunction( 'load_textdomain', array(
			'times' => 1,
			'args' => array( 'a1dmonitor', 'lang_dir/a1dmonitor/a1dmonitor-en_US.mo' ),
		) );
		...
		\WP_Mock::wpFunction( 'load_plugin_textdomain', array(
			'times' => 1,
			'args' => array( 'a1dmonitor', false, 'path/languages/' ),
		) );
